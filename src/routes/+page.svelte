	...
	<section class="py-5 pb-20 px-7 max-w-5xl mx-auto">
		...
		<ProjectTable>
			...
			<Project
				...
				logoPath="/logos/final-trial.png"
			/>
			<Project
				name="Blokator"
